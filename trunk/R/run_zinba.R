run.zinba=function(win_list=NULL,seq,align=NULL,input=NULL,cnvarray=NULL,twoBit=NULL,winSize=500,offset=0,aThresh=1,percN=0.1,gb=NULL,basecountfile=NULL,covs="",threshold=0.01,numProc=1,printLog=FALSE,method='pscl'){
	time.start <- Sys.time()
        if(is.null(win_list)){
