...
run.zinba=function(paramFile=NULL,seq=NULL,align=NULL,input=NULL,twoBit=NULL,winSize=500,offset=0,cnvWinSize=100000,cnvOffset=0,percN=0.1,basecountfile=NULL,threshold=0.01,numProc=1,buildwin=0,winoffset=500,refinepeaks=1,printLog=0,method='pscl'){
	time.start <- Sys.time()
        if(buildwin==1){
