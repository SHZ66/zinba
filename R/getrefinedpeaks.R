getrefinedpeaks=function(winlist,coordout,basecountfile,bpout,peakout,twoBit,winSize,pWinSize=200,pquant=0.75,peakconfidence=.8,threshold=.01,method='pscl'){
